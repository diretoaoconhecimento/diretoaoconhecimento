...
### 👨‍💻 Sobre Mim
Sou a criadora do projeto **Direto ao Conhecimento**, onde transformo tecnologia complexa em aprendizado prático. Meu foco é democratizar o acesso ao desenvolvimento de software, automação e análise de dados.

- 🐍 Especialista em **Python** (Flask, Pandas, Flet)
- 🌐 Desenvolvedor Web (**HTML, CSS, Bootstrap**)
- 🤖 Entusiasta de **Inteligência Artificial** e Automação
- 📊 Analista de Dados focado em APIs Governamentais
...
### 📫 Vamos nos conectar?
[![Website](https://img.shields.io/badge/Direto%20ao%20Conhecimento-442C2E?style=for-the-badge&logo=google-chrome&logoColor=white)(www.diretoaoconhecimento.com.br)
